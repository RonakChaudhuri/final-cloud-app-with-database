...
def submit(request, course_id):
    ...
    if request.method == 'POST':
        ...
        # Use the extract_answers method to get selected choice ids
...
def show_exam_result(request, course_id, submission_id):
    ...
    # Calculate the passing score (you can customize this based on your criteria)
    passing_score = len(course.question_set.all()) / 2  # For example, passing score is 50%
